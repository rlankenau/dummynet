...
@echo ######################################################################
ipfw pipe 3 config delay 100ms mask all
...
@echo ##############################################
ipfw pipe 3 config delay 300ms mask all
ipfw pipe show
...
@echo ##################################
ipfw pipe 3 config bw 500Kbit/s mask all
ipfw pipe show
...
@echo ###################################
ipfw pipe 3 config bw 250Kbit/s mask all
ipfw pipe show
wget http://info.iet.unipi.it/~luigi/1m
@del 1m
